...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 16-Out-2023 às 14:36
...
INSERT INTO `livros` (`idLivro`, `titulo`, `autor`, `capa`, `capa2`, `banca`, `pdf`) VALUES
...
--
ALTER TABLE `livros`
  MODIFY `idLivro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
